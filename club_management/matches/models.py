...
from players.models import refree,stadium
...
class Match(models.Model):
    ...
    ref=models.ForeignKey(refree, on_delete=models.CASCADE, related_name='refree',null=True)
    stad=models.ForeignKey(stadium, on_delete=models.CASCADE, related_name='stad',null=True)
