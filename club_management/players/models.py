...
class refree(models.Model):
    ...
    rimage = models.ImageField(upload_to=upload_image_path, null=True, blank=True)
    rage = models.PositiveIntegerField(null=True, blank=True)
...
class stadium(models.Model):
    ...
    simage = models.ImageField(upload_to=upload_image_path, null=True, blank=True)
